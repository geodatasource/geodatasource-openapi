...
GeoDataSource provides [various APIs](https://geodatasource.com/) to help you to for a city by using latitude and longitude coordinate, or lookup the associated land border countries (the neighboring countries) based on the input of country code in ISO3166-2 format.
